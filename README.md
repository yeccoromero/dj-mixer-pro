...
- **Panel de efectos** (Siren, Airhorn, Laser, Radio) sintetizados con Tone.js (distorsión, coro, delay, bitcrusher), ubicado en el header junto al título, con hotkeys de teclado (1, 2, 3, 4) para dispararlos sin usar el mouse — Tone.js (la dependencia más pesada del proyecto) se descarga recién al tocar el primer efecto, no al abrir la app
