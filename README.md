...
- **Cue al estilo CDJ**: barra de posición tocable/arrastrable (como el buscador de YouTube) para buscar el momento, botón MARCAR para guardarlo ahí mismo, y CUE con toque corto (salta sin cortar la reproducción, útil para loops manuales) o mantener presionado (vista previa, vuelve y pausa al soltar)
